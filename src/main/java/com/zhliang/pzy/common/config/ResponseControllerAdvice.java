package com.zhliang.pzy.common.config;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.zhliang.pzy.common.core.annotation.NotResponseBody;
...
@RestControllerAdvice(basePackages = {"com.zhliang.pzy.**"})
public class ResponseControllerAdvice implements ResponseBodyAdvice<Object> {
    ...
    public boolean supports(MethodParameter returnType, Class<? extends HttpMessageConverter<?>> aClass) {
        ...
        return !(returnType.getParameterType().equals(BaseResponse.class) || returnType.hasMethodAnnotation(NotResponseBody.class));
    }
    ...
    public Object beforeBodyWrite(Object data, MethodParameter returnType, MediaType mediaType, Class<? extends HttpMessageConverter<?>> aClass, ServerHttpRequest request, ServerHttpResponse response) {
        ...
        if (returnType.getGenericParameterType().equals(String.class)) {
            ...
            try {
                ...
                return objectMapper.writeValueAsString(new CResponse<>(data));
